...
public class PetProvider extends ContentProvider {
    ...
    /**
     * URI matcher code for the content UTI for a single pet in the pets table
     */
    public static final int PET_ID = 101;
    /**
     * URI matcher code to match a context URI to a coresponding code.
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        //Check if the breed is not null
        if (breed == null)
            throw new IllegalArgumentException("Pet requires a breed");
        if (weight <= 0)
            throw new IllegalArgumentException("Pet requires weight > 0");
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        //If the PET_NAME key is present,
        //check that the name value is not a null
        ...
        //If the PET_GENDER is present,
        //check that the name value is not a null and it is valid
