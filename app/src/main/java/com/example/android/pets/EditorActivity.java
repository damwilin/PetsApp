...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    /**
     * Uri for current pet
     * null, when creating new pet
     */
    private Uri currentPetUri;

    /**
     * Flag for checking if there is some changes in pet
     */
    ...
    private void savePet() {
        ...
        //Check if this is suppsed to be a new pet
    ...
    private void deletePet() {
        ...
        if (currentPetUri != null) {
            ...
            //Pass in null for the selection and selection args because the currentPetUri
            ...
            if (rowsDeleted == 0) {
                ...
                //Otherwise, the deleted was successful and we can display a toast.
